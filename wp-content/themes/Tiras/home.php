        ...
        <ul>
          ...
          <li>
            <a href="http://localhost:8080/wordpress/about/" data-header="about">
              ...
              <p class="tnav-text js-text-split">About<i> us</i></p>
            </a>
          </li>
          <li class="tnav-line">
            <div><span></span></div>
          ...
          <li>
            <a href="http://localhost:8080/wordpress/members/" data-header="member">
              ...
              <p class="tnav-text js-text-split">Member</p>
            </a>
          </li>
          <li class="tnav-line">
            <div><span></span></div>
          ...
          <li>
            <a href="http://localhost:8080/wordpress/portfolio/" data-header="works">
              ...
              <p class="tnav-text js-text-split">Works</p>
            </a>
          </li>
          <li class="tnav-line">
            <div><span></span></div>
          ...
          <li>
            <a href="http://localhost:8080/wordpress/careers/" data-header="careers">
              ...
              <p class="tnav-text js-text-split">Careers</p>
            </a>
          </li>
          <li class="tnav-line">
            <div><span></span></div>
          ...
          <li>
            <a href="http://localhost:8080/wordpress/contact/" data-header="contact">
              ...
              <p class="tnav-text js-text-split">Contact</p>
            </a>
          </li>
          <li class="tnav-line line-edge">
            <div><span></span></div>
