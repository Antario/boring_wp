		...
		<section id="js-about" class="about">
			...
			<section class="content-inner">
				<section class="about-service content-box js-animation">
					...
					<div class="content-box-inner">
						...
						<a href="http://localhost:8080/wordpress/contact/" class="text-link" data-pjax="true"><span class="icon-arrow-right"></span><span>Контактна форма</span></a>
					</div>
				</section> <!--/ .service -->
			...
			<section class="about-access">
				<div class="content-inner">
					...
					<a href="https://goo.gl/maps/PSSKzwmQjuj" class="btn" target="_blank">View on Google Maps</a>
				</div>
			</section>
