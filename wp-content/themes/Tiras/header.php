...
<html lang="uk">
  ...
  <head>
    ...
    <!-- Icons -->
    <link rel="icon shortcut" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png" sizes="64x64">
    <link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png" sizes="192x192">
    <link rel="apple-touch-icon-precomposed" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="57x57" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="60x60" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="120x120" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="apple-touch-icon-icon-precomposed" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/img/icon/icon-64.png">
    <link rel="manifest" href="<?php echo get_template_directory_uri(); ?>/img/icon/manifest.json">
    <link rel="mask-icon" href="<?php echo get_template_directory_uri(); ?>/img/icon/safari-pinned-tab.svg"
					color="#8bb9fs">
    <!-- Apps Theme -->
    ...
    <meta name="theme-color" content="#8bb9f5">
    <!-- CSS & JavaScript -->
